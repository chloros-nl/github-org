...
# Self-hosted runners are not managed here (the provider manages only the paid
# runner GROUPS, not the runner agents). On Free, register runners into the org's
# built-in "Default" group out of band — see the README.
